export default {
  ...
  login: {
    ...
    phone_number: 'Notre numero de telephone (ex: +XXXYYYXXXX)',
    newPpassword: 'Nouveau mot de passe',
    ...
    passwordChangeTitle: 'Modification nécessaire',
    ...
    siteConfigErrorReturn: 'Il y a une erreur, veuillez retourner a la page précédente',
    siteSetup: 'Installation',
    validateAWSAccountId: 'Entrez votre numéro du compte AWS pour procéder',
    accountid: '##########',
    loginSubmit: 'Valider',
    AccountIdRequirements: 'Vous devez entrez votre numéro du compte AWS pour procéder à la configuration',
    ...
    codeSoftware: 'Entrez le code ici',
    ...
    firstTimeNonCognito: 'Bienvenu, veuillez vous connecter',
    passwordOutput: 'L\'utilisateur d\'administration se retrouve dans les \'sorties\' du template créer.',
