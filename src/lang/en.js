export default {
  ...
  login: {
    ...
    firstTimeNonCognito: 'Welcome, site not yet configured, please login using admin@acentera.com',
    passwordOutput: 'The temporary password can be found in the template \'outputs\'.',
